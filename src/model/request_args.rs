...
impl InputArgs {
    pub fn new(post_data: &Json<InputArgs>) -> InputArgs {
        InputArgs {
            q: post_data.q.clone(),
            from: post_data.from.clone(),
            to: post_data.to.clone(),
            voice: post_data.voice,
            speak_origin_language: post_data.speak_origin_language,
            speak_target_language: post_data.speak_target_language,
        }
    }
}
